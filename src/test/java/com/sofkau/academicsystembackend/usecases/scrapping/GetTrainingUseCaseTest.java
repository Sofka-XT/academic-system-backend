...
class GetTrainingUseCaseTest {
  ...
  void getDataToScrap(){
    ...
    List<Apprentice> listOfApprentices1 = new ArrayList<Apprentice>();
    ...
    List<Apprentice> listOfApprentices2 = new ArrayList<Apprentice>();
    ...
    List<Coach> listOfCoaches = new ArrayList<Coach>();
